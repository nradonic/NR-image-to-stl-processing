...
public class WindowManager {
    ...
    private Map<Integer, ImageDisplayWindow> windowsBySequence; // Track windows by sequence number
    ...
    public ImageDisplayWindow createAndShowWindow(int[][][] imageArray, String functionName, 
        ...
        ImageDisplayWindow window = new ImageDisplayWindow(imageArray, functionName, seqNum, sourceSeqNum);
